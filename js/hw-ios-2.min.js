...
},1)},!1),m){var r=$("apploader");r.parentNode.removeChild(r)}else setTimeout(function(){var a=$("apploader");a&&(a.classList.add("hide"),f(a,"TransitionEnd",function(){a.parentNode.removeChild(a)}))},200);m&&setTimeout(function(){$("view-about").classList.add("animated")},400),hw.news.options.disclosure=!m,hw.init()}(window);
//# sourceMappingURL=hw-ios-2.min.map