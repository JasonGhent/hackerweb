...
return!0}}}();TWEEN.Tween=function(a){var b=a,c={},d={},e={},f=1e3,g=0,h=!1,i=!1,j=!1,k=0,l=null,m=TWEEN.Easing.Linear.None,n=TWEEN.Interpolation.Linear,o=[],p=null,q=!1,r=null,s=null;for(var t in a)c[t]=parseFloat(a[t],10);this.to=function(a,b){return void 0!==b&&(f=b),d=a,this},this.start=function(a){TWEEN.add(this),i=!0,q=!1,l=void 0!==a?a:"undefined"!=typeof window&&void 0!==window.performance&&void 0!==window.performance.now?window.performance.now():Date.now(),l+=k;for(var f in d){if(d[f]instanceof Array){if(0===d[f].length)continue;
d[f]=[b[f]].concat(d[f])}c[f]=b[f],c[f]instanceof Array==!1&&(c[f]*=1),e[f]=c[f]||0}return this},this.stop=function(){return i?(TWEEN.remove(this),i=!1,this.stopChainedTweens(),this):this},this.stopChainedTweens=function(){for(var a=0,b=o.length;b>a;a++)o[a].stop()},this.delay=function(a){return k=a,this},this.repeat=function(a){return g=a,this},this.yoyo=function(a){return h=a,this},this.easing=function(a){return m=a,this},this.interpolation=function(a){return n=a,this},this.chain=function(){return o=arguments,this
},this.onStart=function(a){return p=a,this},this.onUpdate=function(a){return r=a,this},this.onComplete=function(a){return s=a,this},this.update=function(a){var i;if(l>a)return!0;q===!1&&(null!==p&&p.call(b),q=!0);var t=(a-l)/f;t=t>1?1:t;var u=m(t);for(i in d){var v=c[i]||0,w=d[i];w instanceof Array?b[i]=n(w,u):("string"==typeof w&&(w=v+parseFloat(w,10)),"number"==typeof w&&(b[i]=v+(w-v)*u))}if(null!==r&&r.call(b,u),1==t){if(g>0){isFinite(g)&&g--;for(i in e){if("string"==typeof d[i]&&(e[i]=e[i]+parseFloat(d[i],10)),h){var x=e[i];
e[i]=d[i],d[i]=x,j=!j}c[i]=e[i]}return l=a+k,!0}null!==s&&s.call(b);for(var y=0,z=o.length;z>y;y++)o[y].start(a);return!1}return!0}},TWEEN.Easing={Linear:{None:function(a){return a}},Quadratic:{In:function(a){return a*a},Out:function(a){return a*(2-a)},InOut:function(a){return(a*=2)<1?.5*a*a:-.5*(--a*(a-2)-1)}},Cubic:{In:function(a){return a*a*a},Out:function(a){return--a*a*a+1},InOut:function(a){return(a*=2)<1?.5*a*a*a:.5*((a-=2)*a*a+2)}},Quartic:{In:function(a){return a*a*a*a},Out:function(a){return 1- --a*a*a*a
},InOut:function(a){return(a*=2)<1?.5*a*a*a*a:-.5*((a-=2)*a*a*a-2)}},Quintic:{In:function(a){return a*a*a*a*a},Out:function(a){return--a*a*a*a*a+1},InOut:function(a){return(a*=2)<1?.5*a*a*a*a*a:.5*((a-=2)*a*a*a*a+2)}},Sinusoidal:{In:function(a){return 1-Math.cos(a*Math.PI/2)},Out:function(a){return Math.sin(a*Math.PI/2)},InOut:function(a){return.5*(1-Math.cos(Math.PI*a))}},Exponential:{In:function(a){return 0===a?0:Math.pow(1024,a-1)},Out:function(a){return 1===a?1:1-Math.pow(2,-10*a)},InOut:function(a){return 0===a?0:1===a?1:(a*=2)<1?.5*Math.pow(1024,a-1):.5*(-Math.pow(2,-10*(a-1))+2)
}},Circular:{In:function(a){return 1-Math.sqrt(1-a*a)},Out:function(a){return Math.sqrt(1- --a*a)},InOut:function(a){return(a*=2)<1?-.5*(Math.sqrt(1-a*a)-1):.5*(Math.sqrt(1-(a-=2)*a)+1)}},Elastic:{In:function(a){var b,c=.1,d=.4;return 0===a?0:1===a?1:(!c||1>c?(c=1,b=d/4):b=d*Math.asin(1/c)/(2*Math.PI),-(c*Math.pow(2,10*(a-=1))*Math.sin(2*(a-b)*Math.PI/d)))},Out:function(a){var b,c=.1,d=.4;return 0===a?0:1===a?1:(!c||1>c?(c=1,b=d/4):b=d*Math.asin(1/c)/(2*Math.PI),c*Math.pow(2,-10*a)*Math.sin(2*(a-b)*Math.PI/d)+1)
},InOut:function(a){var b,c=.1,d=.4;return 0===a?0:1===a?1:(!c||1>c?(c=1,b=d/4):b=d*Math.asin(1/c)/(2*Math.PI),(a*=2)<1?-.5*c*Math.pow(2,10*(a-=1))*Math.sin(2*(a-b)*Math.PI/d):c*Math.pow(2,-10*(a-=1))*Math.sin(2*(a-b)*Math.PI/d)*.5+1)}},Back:{In:function(a){var b=1.70158;return a*a*((b+1)*a-b)},Out:function(a){var b=1.70158;return--a*a*((b+1)*a+b)+1},InOut:function(a){var b=2.5949095;return(a*=2)<1?.5*a*a*((b+1)*a-b):.5*((a-=2)*a*((b+1)*a+b)+2)}},Bounce:{In:function(a){return 1-TWEEN.Easing.Bounce.Out(1-a)
},Out:function(a){return 1/2.75>a?7.5625*a*a:2/2.75>a?7.5625*(a-=1.5/2.75)*a+.75:2.5/2.75>a?7.5625*(a-=2.25/2.75)*a+.9375:7.5625*(a-=2.625/2.75)*a+.984375},InOut:function(a){return.5>a?.5*TWEEN.Easing.Bounce.In(2*a):.5*TWEEN.Easing.Bounce.Out(2*a-1)+.5}}},TWEEN.Interpolation={Linear:function(a,b){var c=a.length-1,d=c*b,e=Math.floor(d),f=TWEEN.Interpolation.Utils.Linear;return 0>b?f(a[0],a[1],d):b>1?f(a[c],a[c-1],c-d):f(a[e],a[e+1>c?c:e+1],d-e)},Bezier:function(a,b){var c,d=0,e=a.length-1,f=Math.pow,g=TWEEN.Interpolation.Utils.Bernstein;
...
window.requestAnimationFrame||(window.requestAnimationFrame=function(b){var c=(new Date).getTime(),d=Math.max(0,16-(c-a)),e=window.setTimeout(function(){b(c+d)},d);return a=c+d,e}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(a){clearTimeout(a)})}(),function(a){TEMPLATES={"comments-toggle":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.b('<button class="comments-toggle">'),d.b(d.v(d.f("comments_count",a,b,0))),d.b(" "),d.b(d.v(d.f("i_reply",a,b,0))),d.b("</button>"),d.fl()
...
}),a.pop()),d.s(d.f("load_error",a,b,1),a,b,0,109,161,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="load-error">Couldn\'t load stories.</div>')}),a.pop()),d.fl()},partials:{},subs:{}})}}(Hogan.Template),function(a){window.localStorage.clear(),console.log(localStorage),window.sessionStorage.clear(),console.log(sessionStorage);var b=function(){var a=navigator.userAgent.toLowerCase();return-1!=a.indexOf("safari")?a.indexOf("chrome")>-1?!1:!0:!1},c=document.createElement("meta");c.id="viewport",c.name="viewport",c.content="width=device-width, initial-scale=1.0",b()&&(c.content+=", minimal-ui"),document.getElementsByTagName("head")[0].appendChild(c);
var d=a.document,e=a.$=function(a){return d.getElementById(a)},f={},g=function(a){var b={};for(var c in a)a.hasOwnProperty(c)&&(b[c]=a[c]);return b},h={pub:function(a,b){var c=f[a];if(c)for(var d=0,e=c.length;e>d;d++)c[d].call(this,b)},sub:function(a,b){f[a]||(f[a]=[]),f[a].push(b)},currentView:null,hideAllViews:function(){for(var a=d.querySelectorAll(".view"),b=0,c=a.length;c>b;b++)a[b].classList.add("hidden")},tmpl:function(a,b){var c=TEMPLATES[a];if(c)return b?c.render(b):c},setTitle:function(a){var b="HackerWeb";
a&&(a=a.replace(/^\s+|\s+$/g,""),a.toLowerCase()!=b.toLowerCase()&&(b=a+" – "+b)),document.title=b}};"undefined"!=typeof ga&&h.sub("logAPIError",function(a){ga("send","event","Errors","API",a)});var i=h.tmpl;amplify.store.sessionStorage&&"function"==typeof amplify.store.sessionStorage||(amplify.store.sessionStorage=amplify.store.memory);var j=d.createElement("a"),k={},l=function(a){var b=k[a];if(b)return b;j.href=a;var c=j.hostname.replace(/^www\./,""),d=j.pathname.replace(/^\//,"").split("/")[0],e=d.length,f=c.length<=25&&e>3&&15>=e&&/^[^0-9][^.]+$/.test(d)?"/"+d:"";
return b=c+f},m=d.querySelector("#view-home .scroll"),n=m.querySelector("section"),o=!1;h.news={options:{disclosure:!0},markupStory:function(a){return/^item/i.test(a.url)?a.url="#/item/"+a.id:(a.external=!0,a.domain=l(a.url)),h.news.options.disclosure?(a.detail_disclosure=!0,/^#\//.test(a.url)&&(a.disclosure=!0,a.domain=null)):a.id&&(a.url="#/item/"+a.id),setTimeout(function(){amplify.store.sessionStorage("hacker-comments-"+a.id)&&(txt=document.querySelectorAll("#story-"+a.id+" .metadata")[0],txt&&txt.style&&(txt.style.opacity="1.0"))
},200),a.i_point=1==a.points?"point":"points",a.i_comment=1==a.comments_count?"comment":"comments",i("post",a)},markupStories:function(a,b){var c="";b||(b=1);var d=h.news.markupStory;return a.forEach(function(a){a.i=b++,c+=d(a)}),c},updateStory:function(a){if(a&&a.id){var b,c=a.id,d=a.data,f="hacker-news",g=amplify.store(f);if(g)for(var i=0,j=g.length;j>i;i++){var k=g[i];if(c==k.id){b=k;break}}if(!b&&(f="hacker-news2",g=amplify.store(f)))for(var i=0,j=g.length;j>i;i++){var k=g[i];if(c==k.id){b=k;
break}}if(b){var l=!1;if(["title","url","time_ago","comments_count","points"].forEach(function(a){var c=d[a];b[a]!=c&&(b[a]=c,l=!0)}),l){amplify.store(f,g);var m=e("story-"+c);m&&(b.selected=!!m.querySelector("a[href].selected"),b.i=m.dataset?m.dataset.index:m.getAttribute("data-index"),m.insertAdjacentHTML("afterend",h.news.markupStory(b)),m.parentNode.removeChild(m))}}}},render:function(a){if(!o){a||(a={});var b=amplify.store("hacker-news-cached"),c=i("stories-load"),d=function(a){var b=a.slice(),c='<ul class="tableview tableview-links" id="hwlist">'+h.news.markupStories(b)+(amplify.store("hacker-news2")?'<li><a class="more-link">More&hellip;<span class="loader"><i class="icon-loading"></i></span></a></li>':"")+"</ul>";
n.innerHTML=c,h.pub("onRenderNews")};if(b){var f=amplify.store("hacker-news"),g=a.delay;g?(o=!0,n.innerHTML=c.render({loading:!0}),setTimeout(function(){o=!1,d(f)},g)):d(f)}else{o=!0,n.innerHTML=c.render({loading:!0});var j=function(){n.innerHTML=c.render({load_error:!0}),h.pub("logAPIError","news")};hnapi.news(function(a){return o=!1,!a||a.error?void j():(amplify.store("hacker-news",a),amplify.store("hacker-news-cached",!0,{expires:864e5}),h.comments.stack.consume(),h.comments.stack.add(a.reverse()),d(a),void hnapi.news2(function(a){a&&!a.error&&(amplify.store("hacker-news2",a),h.comments.stack.add(a),e("hwlist").insertAdjacentHTML("beforeend",'<li><a class="more-link">More&hellip;<span class="loader"></span></a></li>'))
}))},function(){o=!1,j()})}}},reload:function(){h.news.render({delay:300})},more:function(a){a.classList.add("loading");var b=amplify.store("hacker-news2");setTimeout(function(){a.classList.remove("loading");var c=a.parentNode;if(c&&(c.parentNode&&c.parentNode.removeChild(c),b)){var d=b.slice(),f=h.news.markupStories(d,31);e("hwlist").insertAdjacentHTML("beforeend",f)}},400)}};var p=e("view-comments"),q=p.querySelector("header h1"),r=p.querySelector("section");h.comments={stack:{content:[],process:0,consume:function(){var a=this;
setInterval(function(){if(a.content.length>0&&a.process<=2){a.process++;var b=a.content.pop();if(!b.id)return a.process--;"job"===b.type&&(b.id="000"+b.id),h.comments.getItemDetails(b.id,function(){txt=document.querySelectorAll("#story-"+b.id+" .metadata")[0],txt&&txt.style&&(txt.style.opacity="1.0"),a.process--})}},100)},add:function(a){for(var b=this,c=a.length-1;c>=0;c--)b.content.push(a[c])}},currentID:null,loadComments:function(a,b){if(a&&!a.error){var c=g(a);amplify.store.sessionStorage("hacker-comments-"+b,c);
var d=r.querySelector(".comments>ul");if(d.querySelector(".more-link-container")||d.insertAdjacentHTML("beforeend",'<li class="more-link-container"><a class="more-link" data-id="'+b+'">More&hellip;</a></li>'),c.more_comments_id){var e=function(a){var b=amplify.store.sessionStorage("hacker-comments-"+a);b?b.more_comments_id&&e(b.more_comments_id):hnapi.comments(a,function(b){b&&!b.error&&(amplify.store.sessionStorage("hacker-comments-"+a,b),b.more_comments_id&&e(b.more_comments_id))})};e(c.more_comments_id)
}}},loadPost:function(a,b){var c=this.loadComments,e=g(a),f=i("post-comments");if(e.has_post=!!e.title,!e.has_post)return h.setTitle(),q.innerHTML="",r.innerHTML=f.render(e),h.pub("adjustCommentsSection"),void h.pub("onRenderComments");var j=i("comments");if(/^item/i.test(e.url)?e.url="http://news.ycombinator.com/"+e.url:e.domain=l(e.url),e.has_comments=e.comments&&!!e.comments.length,e.i_point=1==e.points?"point":"points",e.i_comment=1==e.comments_count?"comment":"comments",e.has_content=!!e.content,e.poll){var k=0,m=0;
e.poll.forEach(function(a){var b=a.points;b>m&&(m=b),k+=b,a.i_point=1==b?"point":"points"}),e.poll.forEach(function(a){var b=a.points;a.percentage=(b/k*100).toFixed(1),a.width=(b/m*100).toFixed(1)+"%"}),e.has_poll=e.has_content=!0}e.short_hn_url="news.ycombinator.com/item?id="+b,e.hn_url="http://"+e.short_hn_url,h.setTitle(e.title),q.innerHTML=e.title;var n=f.render(e,{comments_list:j}),o=d.createElement("div");o.innerHTML=n;for(var p=o.querySelectorAll("a"),s=0,t=p.length;t>s;s++){var u=p[s];if(u.classList.contains("comment-permalink")){var b=u.dataset?u.dataset.id:u.getAttribute("data-id");
u.href="http://news.ycombinator.com/item?id="+b}u.target="_blank"}var v=e.user;if(v)for(var w=o.querySelectorAll(".user"),s=0,t=w.length;t>s;s++){var x=w[s];x.textContent.trim()==v&&(x.classList.add("op"),x.title="Original Poster")}if(n.length>2e4)for(var y=o.querySelectorAll(".comments>ul>li>ul"),z=i("comments-toggle"),A=0,t=y.length;t>A;A++){var B=y[A],C=B.querySelectorAll(".metadata").length;B.style.display="none",C&&B.insertAdjacentHTML("beforebegin",z.render({comments_count:C,i_reply:1==C?"reply":"replies"}))
}for(;r.hasChildNodes();)r.removeChild(r.childNodes[0]);for(;o.hasChildNodes();)r.appendChild(o.childNodes[0]);if(delete o,e.more_comments_id){var b=e.more_comments_id,D=amplify.store.sessionStorage("hacker-comments-"+b);D?c(D,b):hnapi.comments(b,function(a){c(a,b)})}h.pub("onRenderComments")},render:function(a){if(a){var b=amplify.store.sessionStorage("hacker-item-"+a);if(h.comments.currentID!=a||!b){h.comments.currentID=a;var c=this.loadPost;if(b)r.scrollTop=0,c(b,a);else{var d=amplify.store("hacker-news");
if(d)for(var e=0,f=d.length;f>e;e++){var g=d[e];if(a==g.id){b=g;break}}if(!b){var d=amplify.store("hacker-news2");if(d)for(var e=0,f=d.length;f>e;e++){var g=d[e];if(a==g.id){b=g;break}}}b?(b.loading=!0,c(b,a)):this.getItemDetails(a,!0),this.getItemDetails(a,!0)}}}},getItemDetails:function(a,b){var c=this;hnapi.item(a,function(d){amplify.store.sessionStorage("hacker-item-"+a,d,{expires:864e5}),h.news.updateStory({id:a,data:d}),b&&(b!==!0?b():c.loadPost(d,a))},function(){h.comments.currentID!=a})},toggle:function(a){var b=a.nextElementSibling;
if(b){var c=b.style,d=r.scrollTop;c.display="none"==c.display?"":"none",r.scrollTop=d}},more:function(a){var b=a.dataset?a.dataset.id:a.getAttribute("data-id"),c=amplify.store.sessionStorage("hacker-comments-"+b);if(c){var e=i("comments"),f=i("comments"),g=e.render(c,{comments_list:e}),h=a.parentNode,j=h.parentNode,k=c.more_comments_id,l=d.createElement("ul");l.innerHTML=g;for(var m=l.querySelectorAll("a"),n=0,o=m.length;o>n;n++)m[n].target="_blank";for(var p=l.children,n=0,o=p.length;o>n;n++){var q=p[n].getElementsByTagName("ul")[0],r=q.querySelectorAll(".metadata").length;
q.style.display="none",r&&q.insertAdjacentHTML("beforebegin",f.render({comments_count:r,i_reply:1==r?"reply":"replies"}))}for(k&&amplify.store.sessionStorage("hacker-comments-"+k)&&l.insertAdjacentHTML("beforeend",'<li class="more-link-container"><a class="more-link" data-id="'+k+'">More&hellip;</a></li>'),j.removeChild(h);l.hasChildNodes();)j.appendChild(l.childNodes[0]);delete l}else alert("Oops, the comments have expired.")},reload:function(){h.comments.currentID=null,ruto.reload()}},h.init=function(){h.news.render(),ruto.init()
},a.hw=h,ruto.config({before:function(a,b){h.hideAllViews();var c=e("view-"+b);c.classList.remove("hidden"),h.currentView=b,h.setTitle(c.querySelector("header h1").textContent)},notfound:function(){ruto.go("/")}}).add("/","home").add("/about","about").add(/^\/item\/(\d+)$/i,"comments",function(a,b){h.comments.render(b)})}(window),function(a){var b=a.document,c=b.body,d={clockwise:["flip-out-to-left","flip-in-from-left"],anticlockwise:["flip-out-to-right","flip-in-from-right"]},e=function(a){var b=a["in"],e=a.out,f=b.classList,g=e.classList,h=a.direction,i=a.fn,j=d[h],k=function(){b.removeEventListener("webkitAnimationEnd",k,!1),c.classList.remove("viewport-flip"),g.add("hidden"),f.remove("flip"),g.remove("flip"),g.remove(j[0]),f.remove(j[1]),i&&i.apply()
};c.classList.add("viewport-flip"),f.remove("hidden"),g.add("flip"),f.add("flip"),b.addEventListener("webkitAnimationEnd",k,!1),g.add(j[0]),f.add(j[1])},f={rtl:["slide-out-to-left","slide-in-from-right"],ltr:["slide-out-to-right","slide-in-from-left"]},g=function(a){var b=a["in"],c=a.out,d=b.classList,e=c.classList,g=b.getElementsByTagName("header")[0],h=c.getElementsByTagName("header")[0],i=g.classList,j=h.classList,k=a.direction,l=a.fn,m=f[k],n=function(){e.add("hidden"),b.removeEventListener("webkitAnimationEnd",n,!1),e.remove("sliding"),d.remove("sliding"),e.remove(m[0]),d.remove(m[1]),i.remove("transparent"),j.remove("transparent"),l&&l.apply()
};d.remove("hidden"),e.add("sliding"),d.add("sliding"),b.addEventListener("webkitAnimationEnd",n,!1),i.add("transparent"),j.add("transparent"),e.add(m[0]),d.add(m[1])},h=function(){return a.innerWidth>=640?"wide":"narrow"},i=b.querySelector("meta[name=viewport]");i||(i=b.createElement("meta"),i.name="viewport",b.head.appendChild(i)),i.content="width=device-width, initial-scale=1.0, user-scalable=0, minimum-scale=1.0, maximum-scale=1.0";var j=navigator.userAgent,k=j&&/iPhone|iPod/.test(j),l=parseInt((j.match(/ OS (\d+)_/i)||[,0])[1],10)<6;
k&&l&&c.classList.add("ios5");var m="wide"==h();a.addEventListener("resize",function(){var a="wide"==h();a!=m&&(m=a,location.reload())}),c.insertAdjacentHTML("beforeend",m?'<div id="overlay" class="hide"></div>':'<header class="fake"></header>'),ruto.config({before:function(a,b,c){var d=hw.currentView,f=hw.hideAllViews,h=$("view-"+b);switch(hw.setTitle(h.querySelector("header h1").textContent),b){case"home":if(m){f(),$("overlay").classList.add("hide"),h.classList.remove("hidden");var i=$("view-comments");
i.classList.remove("hidden"),i.querySelector("section").innerHTML='<div class="view-blank-state"><div class="view-blank-state-text">No Story Selected.</div></div>',i.querySelector("header h1").innerHTML="",i.querySelector("header a.header-back-button").style.display="none",hw.comments.currentID=null,hw.pub("selectCurrentStory")}else d?"about"==d?e({in:h,out:$("view-"+d),direction:"anticlockwise"}):"home"!=d&&g({in:h,out:$("view-"+d),direction:"ltr"}):(f(),h.classList.remove("hidden"));hw.currentView="home";
break;case"about":m?(h.classList.remove("hidden"),$("view-home").classList.remove("hidden"),$("view-comments").classList.remove("hidden"),setTimeout(function(){$("overlay").classList.remove("hide")},1)):d?"about"!=d&&e({in:h,out:$("view-home"),direction:"clockwise"}):(f(),h.classList.remove("hidden")),hw.currentView="about";break;case"comments":if(m)f(),$("overlay").classList.add("hide"),h.classList.remove("hidden"),$("view-home").classList.remove("hidden"),hw.pub("selectCurrentStory",c[1]),h.querySelector("header a.header-back-button").style.display="";
else if(d){if("comments"!=d){var j=c[1];j&&hw.comments.currentID!=j&&(h.querySelector("section").scrollTop=0),g({in:h,out:$("view-"+d),direction:"rtl"})}}else f(),h.classList.remove("hidden");hw.currentView="comments"}}}),a.addEventListener("pagehide",function(){for(var a=b.querySelectorAll(".view"),c={},d=0,e=a.length;e>d;d++){var f=a[d];c[f.id]=f.querySelector(".scroll section").scrollTop||0}amplify.store("hacker-scrolltops",c)},!1);var n=function(){var a=amplify.store("hacker-scrolltops");setTimeout(function(){for(var b in a)$(b).querySelector(".scroll section").scrollTop=a[b]
},1)};if(a.addEventListener("pageshow",n,!1),n(),k){var o=b.querySelectorAll(".view>.scroll"),p=null;Array.prototype.forEach.call(o,function(d){d.addEventListener("touchstart",function(){if(a.innerHeight!=p){if(a.scrollTo(0,0),l){var d=b.createElement("div");d.style.height="600px",c.appendChild(d),setTimeout(function(){c.removeChild(d)},100)}p=a.innerHeight}},!1)})}tappable(".view>header a.header-button[href]",{noScroll:!0,onTap:function(a,b){var c=b.hash;m&&/about/i.test(ruto.current)&&"#/"==c?ruto.back("/"):location.hash=c
}}),tappable("#view-home-refresh",{noScroll:!0,onTap:hw.news.reload});var q=!1;tappable(".view>header h1",{onTap:function(a,b){var d=b.parentNode.nextElementSibling.firstElementChild;if(0==d.scrollTop||q){if(k){var e=c.style.height;c.style.height="100%",setTimeout(function(){c.style.height=e},100)}}else{if(q)return;q=!0;var f=d.style.overflow;d.style.overflow="hidden",setTimeout(function(){d.style.overflow=f;var a,b=new TWEEN.Tween({scrollTop:d.scrollTop}).to({scrollTop:0},300).easing(TWEEN.Easing.Cubic.InOut).onUpdate(function(){d.scrollTop=this.scrollTop
}).onComplete(function(){cancelAnimationFrame(a),b.stop(),q=!1,delete b}).start(),c=function(){TWEEN.update(),requestAnimationFrame(c)};a=requestAnimationFrame(c)},200)}}});var r;tappable("#view-home .tableview-links li>a:first-child",{allowClick:!m,activeClassDelay:100,inactiveClassDelay:m?100:1e3,onStart:function(a,b){if(m){var c=b.parentNode;c&&(c=c.parentNode,r=setTimeout(function(){c&&c.classList.add("list-tapped")},100))}},onMove:function(){m&&clearTimeout(r)},onEnd:function(a,b){if(m){clearTimeout(r);
var c=b.parentNode.parentNode;setTimeout(function(){c&&c.classList.remove("list-tapped")},100)}},onTap:function(b,c){c.classList.contains("more-link")?hw.news.more(c):/^#\//.test(c.getAttribute("href"))?location.hash=c.hash:c.href&&m&&a.open(c.href)}}),tappable("#view-about .grouped-tableview-links li>a:first-child",{allowClick:!0,activeClassDelay:100,inactiveClassDelay:1e3}),tappable("#view-home .tableview-links li>a.detail-disclosure-button",{noScroll:!0,noScrollDelay:100,onTap:function(a,b){location.hash=b.hash
}}),tappable("button.comments-toggle",function(a,b){hw.comments.toggle(b)}),tappable("section.comments li>a.more-link",function(a,b){hw.comments.more(b)}),tappable("#view-comments .load-error button",hw.comments.reload),hw.sub("selectCurrentStory",function(a){if(m){a||(a=(location.hash.match(/item\/(\d+)/)||[,""])[1]);for(var b=$("view-home"),c=b.querySelectorAll("a[href].selected"),d=0,e=c.length;e>d;d++)c[d].classList.remove("selected");if(a){var f=b.querySelector('a[href*="item/'+a+'"]');f&&(f.classList.add("selected"),setTimeout(function(){f.scrollIntoViewIfNeeded?f.scrollIntoViewIfNeeded():f.scrollIntoView()
},1))}}}),hw.sub("onRenderNews",function(){hw.pub("selectCurrentStory")}),a.addEventListener("pageshow",function(){setTimeout(function(){"home"==hw.currentView&&$("hwlist")&&!amplify.store("hacker-news-cached")&&hw.news.reload()},1)},!1);var s=function(){var a=b.querySelector("#view-comments section");if(a){var c=a.querySelector(".post-content"),d=a.querySelector(".comments");if(d){var e=a.offsetHeight-c.offsetHeight+1,f=$("comment-section-style");f||(f=b.createElement("style"),f.id="comment-section-style",b.head.appendChild(f)),f.textContent=".view section.comments{min-height: "+e+"px;}"
}}};hw.sub("onRenderComments",function(){setTimeout(s,m?1:360)}),a.addEventListener("resize",s,!1),a.addEventListener("orientationchange",s,!1);var t="undefined"!=typeof a.orientation,u=function(){t&&(c.style.height=screen.height+"px",setTimeout(function(){a.scrollTo(0,0),c.style.height=a.innerHeight+"px"},1))};if(m){var v=$("apploader");v.parentNode.removeChild(v)}else"complete"==b.readyState?u():a.addEventListener("load",u,!1),t&&(a.onorientationchange=u),setTimeout(function(){var a=$("apploader");
a&&(a.classList.add("hide"),a.addEventListener("webkitTransitionEnd",function(){a.parentNode.removeChild(a)},!1))},200);hw.news.options.disclosure=!m,hw.init()}(window);
//# sourceMappingURL=hw-ios.min.map